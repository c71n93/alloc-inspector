...
static droption_t<bool> only_from_app(
        ...
        "Only count app, not lib, stack allocation instructions",
...
dr_client_main(client_id_t id, int argc, const char *argv[])
{
    ...
    dr_log(NULL, DR_LOG_ALL, 1, "Client 'stack_inspector' initializing\n");
...
#    endif
        dr_fprintf(STDERR, "Client stack_inspector is running\n");
    }
}
                      ...
                      bool for_trace, bool translating, void *user_data)
{
    ...
    dr_insert_clean_call(drcontext, bb, instrlist_first_app(bb), (void *) alloc_inscount,
